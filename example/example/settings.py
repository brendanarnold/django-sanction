...
SECRET_KEY = '57m54nh8tuu8t(r7^2c1y^^a8j=z)f6)*t_)@0t5a6-kkbcboz'
...
SANCTION_PROVIDERS = {
    'google': {
        ...
        'client_id': '982905606419.apps.googleusercontent.com',
        'client_secret': 'r-y-X0KbSUrBtpu4neoakcsw',
        'redirect_uri': 'http://localhost:8000/o/login/google',
